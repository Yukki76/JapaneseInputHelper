...
namespace ThemeControl {
    ...
    public class MyColors : ProfessionalColorTable {
        ...
        public override Color MenuItemSelected {
            get => ColorTranslator.FromHtml(DarkMode ? "#353535" : "#B5D7F3");
        }
        // アイテム選択時の枠の色
        public override Color MenuItemBorder {
            get => ColorTranslator.FromHtml(DarkMode ? "#707070" : "#0078D7");
        }
        // アイテム非選択時の色
        public override Color ToolStripDropDownBackground {
            get => ColorTranslator.FromHtml(DarkMode ? "#2B2B2B" : "#FDFDFD");
        }
    }
    ...
    public class MyToolStripMenuItem : ToolStripProfessionalRenderer {
        ...
        // コンストラクタ
        public MyToolStripMenuItem(bool mode) :
            base(new MyColors(mode)) { DarkMode = mode; }
